jQuery.extend({
	...
	View: function($console){
		 ...
		 */
		$console.append($("<input type='button' value='Carga Todos'></input>").click(function(){
			that.notifyAllClicked();
		}));
		$console.append($("<input type='button' value='Carga Uno'></input>").click(function(){
			that.notifyOneClicked();
		}));
		$console.append($("<input type='button' value='Limpia Cache'></input>").click(function(){
			that.notifyClearAllClicked();
		}));
		$console.append($("<input type='button' value='Limpia Consola'></input><br><br>").click(function(){
			$messages.empty();
		}));
